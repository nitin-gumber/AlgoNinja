...
export const PlanBadge = ({ plan, isMobile = false }) => {
  ...
  return (
    <div
      className={`inline-flex items-center px-3 py-1 rounded-xl text-xs font-bold text-white bg-linear-to-r tracking-wider select-none transform hover:scale-105 transition-all duration-300 ${
